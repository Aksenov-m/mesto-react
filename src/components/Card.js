...
function Card(props) {
  ...
  const cardLikeButtonClassName = `card__like-icon ${isLiked ? "card__trash_visible" : ""}`;
  ...
  return (
    <article className='card cards__item'>
      <button className={cardDeleteButtonClassName} type='button' aria-label='deleteCard'></button>
